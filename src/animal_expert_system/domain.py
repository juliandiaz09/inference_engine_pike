...
MODE_LABELS = {
    ...
    RECOGNITION_MODE_BACKWARD: "Encadenamiento hacia atrÃÂ¡s",
}
...
MODE_DESCRIPTIONS = {
    ...
    RECOGNITION_MODE_BACKWARD: (
        "Se plantea una hipÃÂ³tesis de especie y el sistema intenta demostrarla "
        "combinando subobjetivos de caracterÃÂ­sticas."
    ),
}

# Feature configuration for bird taxonomy
# The features are intentionally separated into thematic groups so the UI and
# scoring logic can reason about them independently.
FEATURE_GROUPS = {
...
FEATURE_LABELS = {
    "habitat": "HÃÂ¡bitat",
    "diet": "Tipo de alimentaciÃÂ³n",
    "morphology": "MorfologÃÂ­a",
    "size": "TamaÃÂ±o",
    "activity": "Actividad",
}
...
# Verified bird species database (TaxonomÃÂ­a verificable)
BIRD_SPECIES_DATABASE = {
    "aguila_real": BirdSpecies(
        common_name_es="ÃÂguila Real",
    ...
    "gavilÃÂ°ÃÂ½_cola_roja": BirdSpecies(
        common_name_es="GavilÃÂ¡n Cola Roja",
    ...
    "cuervo_comun": BirdSpecies(
        common_name_es="Cuervo ComÃÂºn",
    ...
    "loro_amazonico": BirdSpecies(
        common_name_es="Loro AmazÃÂ³nico",
    ...
    "paloma_comun": BirdSpecies(
        common_name_es="Paloma ComÃÂºn",
    ...
    "cormoÃâ¬ÃÂ°ÃÂ½_grande": BirdSpecies(
        common_name_es="CormorÃÂ¡n Grande",
    ...
    "halcon_peregrino": BirdSpecies(
        common_name_es="HalcÃÂ³n Peregrino",
    ...
    "pajaro_carpintero": BirdSpecies(
        common_name_es="PÃÂ¡jaro Carpintero",
    ...
    "colibri_amazonia": BirdSpecies(
        common_name_es="ColibrÃÂ­ AmazÃÂ³nico",
...
BIRD_PROFILES = [
    ...
    BirdProfile(
        bird_id="gavilÃÂ°ÃÂ½_cola_roja",
        species=BIRD_SPECIES_DATABASE["gavilÃÂ°ÃÂ½_cola_roja"],
        features={
            "habitat": "forest",
            "diet": "carnivore",
            "morphology": "hooked_beak",
    ...
    BirdProfile(
        bird_id="cormoÃâ¬ÃÂ°ÃÂ½_grande",
        species=BIRD_SPECIES_DATABASE["cormoÃâ¬ÃÂ°ÃÂ½_grande"],
        features={
            "habitat": "coastal",
            "diet": "piscivore",
